        ...
        <CardContent className="p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-xs font-bold text-indigo-950 uppercase tracking-wider">
              How CareerBridge Closes Your Skill Gap to Unlock Opportunities
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
            ...
            <div className="p-3 bg-white rounded-xl border border-slate-200/80 space-y-1 shadow-2xs">
              ...
              <p className="text-[11px] text-slate-500">
                Take standardized timed skill assessments on CareerBridge to earn tamper-proof verified credentials.
              </p>
            </div>
