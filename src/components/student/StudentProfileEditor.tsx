              ...
              {isEditing ? (
                <div className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    />
                    <div>
                      <label className="block text-[11px] font-semibold text-slate-600 mb-1">Current Semester</label>
                      <select
                        value={formData.currentSemester || 'Semester 1'}
                        onChange={(e) => setFormData({ ...formData, currentSemester: e.target.value })}
                        className="w-full px-3 py-2.5 bg-white border border-slate-200 rounded-xl text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                      >
